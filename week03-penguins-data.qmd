...
#alpha = 0.5 adds transparency to visualization
```
...
ggplot(data = penguins_data, aes(x = culmen_depth_mm, color = species, shape = island)) +
  geom_histogram() +
  theme_bw() +
  scale_fill_viridis_d(option = "iris") +
  labs(title = "Flipper Length of Palmers Archipelago penguins",
       subtitle = "Three species observed in Palmer Archipelago",
       x = "Culmen Length (mm)",
